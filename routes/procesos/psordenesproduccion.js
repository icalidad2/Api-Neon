...
// ======================================================
// 🧭 Normalizador de claves (Google Sheets → SQL fields)
// ======================================================
...
// ======================================================
// 🚀 Endpoint: /sync_psordenesproduccion
// ======================================================
router.post("/sync_psordenesproduccion", async (req, res) => {
  try {
    ...
    res.status(500).json({
      ok: false,
      mensaje: "Error al insertar o actualizar orden de producción secundaria",
